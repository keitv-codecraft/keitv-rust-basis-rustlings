...
impl<'a> FroggerBoard<'a> {
    ...
    fn step(&mut self) -> Option<Fate> {
        // TODO: zet een stap door gebruik te maken van self.position
        // en bepaal eventueel de eindtoestand.
        // gebruik self.visited om bij te houden waar je al bent geweest.
        todo!()
    }
}
...
impl<'a> BoardPosition<'a> {
    ...
    fn step(&mut self) {
        ...
        if let Self::Valid(index, board) = *self {
            // TODO: zet een stap door self te updaten
        }
    }
